            ...
            <div className="grid gap-8 md:grid-cols-2">
                ...
                <div className="md:py-8">
                  <div className="mb-2 md:mb-3">
                    <span className="mb-0.5 text-gray-500 inline-block">{data.categoryname}</span>
                  ...
                  <div className="mb-4">
                    ...
                    {/*  */}
                    <span className="text-sm text-gray-500">Incl.Val plus shipping</span>
                  </div>
                  {/*  */}
                  ...
                  <div className="flex gap-2.5">
                   <AddToBag currency="USD" description={data.description} image={data.images[0]} name={data.name} price={data.price} key={data._id} />
